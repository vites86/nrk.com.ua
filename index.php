        ...
        <div class="span6">
            ...
            <div class="carousel-inner">
                ...
                <div class="active item">
                    <p class="quote-text">"У цей нелегкий для нашої країни час знаходяться ось такі хороші люди як колектив 'Нашого рідного краю'. Дякую вам, друзі, за те що ви робите! "<cite>- Віктор Дубровін, <a href="http://www.vdstudio.net.ua">VDStudio</a></cite></p>
                </div>
